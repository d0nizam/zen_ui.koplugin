...
return {
    ...
    ["2.0.0"] = {
        "IMPORTANT: This update has breaking changes, settings will not be saved if you go back to v1.x. Update via settings or completely delete old zen_ui.koplugin",
        ...
        "Updated Quick Settings to launch plugins",
